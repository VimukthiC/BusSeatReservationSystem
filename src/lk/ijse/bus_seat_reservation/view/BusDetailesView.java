...
import lk.ijse.bus_seat_reservation.controller.BusDetailesController;
 ...
 * @author vimukthi
 */
public class BusDetailesView extends javax.swing.JFrame {

    public BusDetailesView() {
        initComponents();
        loadAllBusDetailes();
    ...
    private void initComponents() {
        ...
        tblBus.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Bus ID", "Bus Name", "Bus Category", "Qty of Seats"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BusDetailesView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void loadAllBusDetailes(){
        try {
            List<Bus> allBus = new BusDetailesController().getAllBus();
            
            DefaultTableModel modal=(DefaultTableModel) tblBus.getModel();
            ...
            for (Bus all : allBus) {
                modal.addRow(new Object[]{
                    ...
                    all.getBus_name(),
                    all.getBus_category(),
                    all.getQuantity_of_seat()
                });
            }
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(BusDetailesView.class.getName()).log(Level.SEVERE, null, ex);
