...
import lk.ijse.bus_seat_reservation.controller.PassengerDetailesContrller;
 ...
 * @author vimukthi
 */
public class PassengerDetailesView extends javax.swing.JFrame {

    public PassengerDetailesView() {
        initComponents();
        loadAllPassenger();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("All Passenger Details");
        ...
        tblPassenger.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Passenger ID", "Name", "NIC", "Phone Number"
            }
        ) {
        ...
        if (tblPassenger.getColumnModel().getColumnCount() > 0) {
            tblPassenger.getColumnModel().getColumn(3).setResizable(false);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PassengerDetailesView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void loadAllPassenger() {
        try {
            List<PassengerInformation> all = new PassengerDetailesContrller().getAllPassenger();
            
             DefaultTableModel model = (DefaultTableModel)tblPassenger.getModel();
             
             for (PassengerInformation add : all) {
            ...
            Logger.getLogger(PassengerDetailesView.class.getName()).log(Level.SEVERE, null, ex);
